 ...
 */
package net.cloudkit.ecosystem.enterprises.domain.model.security;

import net.cloudkit.ecosystem.enterprises.domain.model.member.LoginStatus;
import net.cloudkit.ecosystem.enterprises.domain.shared.AbstractEntity;
