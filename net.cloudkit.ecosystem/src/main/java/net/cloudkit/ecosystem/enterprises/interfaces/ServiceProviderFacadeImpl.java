 ...
 */
package net.cloudkit.ecosystem.enterprises.interfaces;
...
@WebService(endpointInterface = "net.cloudkit.ecosystem.enterprises.interfaces.ServiceProviderFacade", targetNamespace = "http://www.cloudkit.net/jax-ws/")
